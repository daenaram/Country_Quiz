...
class Game:
    def __init__(self, how_many):
        ...
        for item in range(0, 4):
            self.options_button = Button(self.options_frame,
                                         ...
                                         bg="#A3D4FF",
                                         width=30, height=2,
                                         command=lambda i=item: self.right_wrong_ans(i))  # Pass the index 'i'
    ...
    def right_wrong_ans(self, selected_option_index):
        right_answer = self.quiz_list[0][1]
        print("you choose", self.button_list_options[selected_option_index])
        ...
        if self.button_list_options[selected_option_index] == right_answer:
