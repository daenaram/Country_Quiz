...
class History:
    def __init__(self, partner, country_question, user_cap):
        ...
        max_quest = 20
        self.max_list = IntVar()
        self.max_list.set(max_quest)

        self.country_list = StringVar()

        country_question.append()
        ...
        self.country_quest = (country_question, "Question")
        self.capital_answer = (user_cap, "User Answer")
    ...
    def get_history(answers_list, entity):
        ...
        return [entity, question_1, question_2, question_3, question_4, question_5]
