...
class Game:
    def __init__(self, how_many):
        ...
        self.game_question = Label(self.game_frame,
                                   text="What is the capital of {}?".format(self.quiz_list[0][0]),
    ...
    def right_wrong_ans(self, user_choice):
        ...
        # deactivate capital buttons
        for item in self.options_button_ref:
            item.cofig(state=DISABLED)
