...
class Game:
    ...
    def to_do(self, action):
        if action == "get help":
            ...
            History(self, self.country_question, self.user_ans, self.right_ans, self.results_question)
...
class History:
    def __init__(self, partner, country_question, user_cap, right_ans, results_question):
        ...
        # shows if the user's answer is right or wrong
        results_game = ""
        for item in results_question:
            results_game += f"{item}"
            results_game += "\n"
        ...
        # frame for the first row / the labels
        self.his_label_frame = Frame(self.history_frame)
        self.his_label_frame.grid(row=1)

        self.first_row = Label(self.his_label_frame, text="Question \t Your Answer \t Right Answer",
                               font=("Arial", "14", "bold"))
        self.first_row.grid(row=0, column=0, padx=10, pady=10)

        self.contents_frame = Frame(self.his_label_frame)
        self.contents_frame.grid(row=2, padx=10, pady=10)

        self.country_question_label = Label(self.contents_frame, font=("Arial", "12"),
                                            text=quiz_question)
        self.country_question_label.grid(row=1, column=0, padx=30, pady=10)

        self.user_cap_label = Label(self.contents_frame, font=("Arial", "12"),
                                    text=user_history)
        self.user_cap_label.grid(row=1, column=1, padx=30, pady=10)

        self.right_ans_label = Label(self.contents_frame, font=("Arial", "12"),
                                     text=right_answer)
        self.right_ans_label.grid(row=1, column=2, padx=30, pady=10)
        #
        # self.right_wrong_ans = Label(self.his_label_frame, font=("Arial", "12"),
        #                              text=results_game)
        # self.right_wrong_ans.grid(row=1, column=3, padx=10, pady=10)
